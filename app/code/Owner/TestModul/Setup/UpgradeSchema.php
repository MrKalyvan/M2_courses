...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    {
        echo 'Owner_TestModul:UpgradeSchema:upgradeStart' . "\r\n";
        ...
        if (version_compare($moduleVersion, '0.0.3', '<')) {
            echo 'Owner_TestModul:UpgradeSchema:upgradeStart:0.0.3' . "\r\n";
            $this->updateMyTable($setup);
            echo 'Owner_TestModul:UpgradeSchema:upgradeEnd:0.0.3' . "\r\n";
        }

        echo 'Owner_TestModul:UpgradeSchema:upgradeEnd' . "\r\n";
    }
